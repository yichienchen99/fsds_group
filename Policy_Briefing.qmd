 ...
 * **The Occupancy model**
     ...
     Since the operation of Airbnb began, contrary to the initial intention of the business, there has been a problem in that the rooms of many hosts function as a substantial hotel (Inside Airbnb, 2023). Therefore, we would like to estimate the frequency of rentals and the revenue through the occupancy model. This model was used by referring to the "San Francisco Model" guided by the Inside Airbnb website. 
